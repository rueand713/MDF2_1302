...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    NSDate *myDate = [[NSDate date] dateByAddingTimeInterval:30];
    ...
    {
        // set the local notification parameters
        myNotification.fireDate = myDate;
        myNotification.timeZone = [NSTimeZone localTimeZone];
        myNotification.alertBody = @"Meep Meep! Ready to check some events?";
